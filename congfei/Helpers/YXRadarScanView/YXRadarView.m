...
#define INDICATOR_START_COLOR [UIColor colorWithRed:184.0/255.0 green:189.0/255.0 blue: 255.0/255.0 alpha:1]
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetRGBStrokeColor(context, 132.0/255, 142.0/255, 255.0/255, 1); //
